...
scat <- read.csv("C:/Users/allis/Documents/UVA-January 2023/train.csv")
plot(scat$beds, scat$baths, pch = 19, col = "black", xlab = "Number of Beds", ylab = "Number of Baths", main = "Scatterplot of Beds and Baths in Seattle, WA")
...
cols <- c('Max Depth', 'RMSE','RMSE2', 'Rsquared', 'Rsquared2')
row1 <- c('1', '28538.27', '28085.70', '0.6778958', '0.6984754')
row2 <- c('2', '26866.28', '24654.45', '0.7104868', '0.7689007')
row3 <- c('3', '13481.91', '12653.23', '0.9286027', '0.9391718')
```
